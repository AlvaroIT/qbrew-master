...
struct qt_meta_stringdata_TextPrinter_t {
    QByteArrayData data[5];
    char stringdata[38];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_TextPrinter_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_TextPrinter_t qt_meta_stringdata_TextPrinter = {
    {
...
QT_MOC_LITERAL(4, 29, 7)
    ...
    "TextPrinter\0print\0\0QPrinter*\0printer\0"
};
...
void TextPrinter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TextPrinter *_t = static_cast<TextPrinter *>(_o);
        switch (_id) {
...
const QMetaObject TextPrinter::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TextPrinter.data,
      qt_meta_data_TextPrinter,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TextPrinter.stringdata))
