...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_HelpViewer_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 44, 4)
    ...
    "HelpViewer\0textChanged\0\0print\0"
    "anchorClicked\0link\0"
};
...
const QMetaObject HelpViewer::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_HelpViewer.data,
      qt_meta_data_HelpViewer,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_HelpViewer.stringdata))
